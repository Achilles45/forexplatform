             ...
             <hr>
                  ...
                  <div class="summary__card one pt-4">
                    ...
                    <div class="summary__card two pt-4">
                     ...
                     <div class="content pl-4">
                         <h6>Expected Monthly Returns</h6>
              ...
              <p>Your investment lifecycle will only begin to count when you have been verified to have made payment for your selected plan. Your returns of 15% of your principal investment would be paid to you on a monthly basis. You can also choose to withdraw your capital at the end of the month Terms and conditions applies. Also, should you find any difficulties in using the platform, kindly use livechat widget to send a message and our customer success team will respond as soon as possible. Happy investing.</p>
              </div>
            <!--End of Dashboard
            =========================-->
              <br>
